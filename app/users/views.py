...
class CreateListUsers(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            user = Users(request_dict['email'], request_dict['password'], request_dict['name'], request_dict[
                         'createddate'], request_dict['createdby'], request_dict['updateddate'], request_dict['updatedby'],)
            user.add(user)
