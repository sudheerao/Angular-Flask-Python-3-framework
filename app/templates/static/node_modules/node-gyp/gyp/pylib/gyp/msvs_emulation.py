...
class MsvsSettings(object):
    ...
    def _TargetConfig(self, config):
        ...
        # account the local target-specific overrides to the global
        # configuration.
    ...
    def GetCflags(self, config):
        ...
        if self.vs_version.short_name in ('2013', '2013e', '2015'):
            ...
            cflags.append('/FS')
        # ninja handles parallelism by itself, don't have the compiler do it
        # too.
    ...
    def GetDefFile(self, gyp_to_build_path):
        ...
        if spec['type'] in ('shared_library', 'loadable_module', 'executable'):
            def_files = [s for s in spec.get(
                'sources', []) if s.endswith('.def')]
            if len(def_files) == 1:
    ...
    def GetLdflags(self, config, gyp_to_build_path, expand_special,
        ...
        ld('OptimizeReferences', map={
           '1': 'NOREF', '2': 'REF'}, prefix='/OPT:')
        ...
        # TODO(scottmg): This should sort of be somewhere else (not really a
        # flag).
