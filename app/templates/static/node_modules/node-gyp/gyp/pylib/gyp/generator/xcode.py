...
sys.exit(subprocess.call(sys.argv[1:]))" """
        ...
        # Get rid of unnecessary levels of depth in groups like the Source
        # group.
            ...
            if int(bf_tgt.get('xcode_create_dependents_test_runner', 0)):
                ...
                if isinstance(xcode_target, gyp.xcodeproj_file.PBXAggregateTarget):
                    ...
                    if len(all_run_tests) > 0:
                        ...
                        idx = self.project._properties[
                            'targets'].index(xcode_target)
...
def GenerateOutput(target_list, target_dicts, data, params):
    ...
    for qualified_target in target_list:
        ...
        for rule in spec_rules:
            ...
            # message is optional, in which case None is stored for each rule
            # source.
            messages = []
            actions = []
            ...
            for rule_source in rule.get('rule_sources', []):
                ...
                # TODO(mark): Should verify that at most one of these is
                # specified.
            ...
            if len(concrete_outputs_all) > 0:
                ...
                for (rule_source, concrete_outputs, message, action) in \
                    ...
                    for concrete_output_index in xrange(0, len(concrete_outputs)):
                        concrete_output = concrete_outputs[
                    ...
                    if message:
                        # Mark it with note: so Xcode picks it up in build
                        # output.
                ...
                # scheduling/other tasks, and randomly failing builds are no
                # good.
                script = \
...
""" % makefile_name
    ...
    for build_file in build_files:
        xcode_projects[build_file].Finalize1(
            xcode_targets, serialize_all_tests)
