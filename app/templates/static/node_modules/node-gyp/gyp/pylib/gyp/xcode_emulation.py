...
class XcodeSettings(object):
    ...
    def __init__(self, spec):
        ...
        # This is only non-None temporarily during the execution of some
        # methods.
    ...
    def GetCflags(self, configname, arch=None):
        ...
        # TODO: This is exported correctly, but assigning to it is not
        # supported.
    ...
    def GetCflagsCC(self, configname):
        ...
        for flag in self._Settings().get('OTHER_CPLUSPLUSFLAGS', ['$(inherited)']):
            # TODO: More general variable expansion. Missing in many other
            # places too.
    ...
    def GetInstallNameBase(self):
        ...
        # Xcode sets this for shared_libraries, and for nonbundled
        # loadable_modules.
...
def GetMacBundleResources(product_dir, xcode_settings, resources):
    ...
    for res in resources:
        ...
        # If the resource lives in a .lproj bundle, add that to the
        # destination.
...
def _GetXcodeEnv(xcode_settings, built_products_dir, srcroot, configuration,
    ...
    env = {
        ...
        # Product\ Types.xcspec for FULL_PRODUCT_NAME
        'SRCROOT': srcroot,
        'SOURCE_ROOT': '${SRCROOT}',
